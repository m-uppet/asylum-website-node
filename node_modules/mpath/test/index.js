      ...
      describe('array.index.array.$.path.path', function () {
        it('with single value', function (done) {
          ...
          assert.deepEqual([
            {
              yep: [15],
              arr: [{a: {b: 'dolla billz'}, e: 'a'}, {a: {c: 48, b: 'dolla billz'}, e: 'b'}, {d: 'yep', e: 35}]
            }
            , {yep: 0}
          ], o.arr);
      ...
      describe('array.array.$.index.path', function () {
        ...
        it('with array', function (done) {
          ...
          assert.deepEqual([
            {
              yep: [15],
              arr: [{a: [4, 8, 15, 16, 23, 42, 108], e: 'a'}, {a: {c: 48, b: [1]}, e: 'b'}, {d: 'yep', e: 35}]
            }
            , {yep: 0}
          ], o.arr);
      ...
      describe('array.array.path.index', function () {
        it('with single value', function (done) {
          ...
          assert.deepEqual([
            {
              yep: [15],
              arr: [{a: [4, 8, 15, 16, 23, 42, 108, 1], e: 'a'}, {a: {c: 48, b: [1], '7': 1}, e: 'b'}, {
                d: 'yep',
                e: 35
              }]
            }
          ...
          assert.deepEqual([
            {
              yep: [15],
              arr: [{a: [4, 8, 15, 16, 23, 42, 108, 47], e: 'a'}, {a: {c: 48, b: [1], '7': 47}, e: 'b'}, {
                d: 'yep',
                e: 35
              }]
            }
        ...
        it('with array', function (done) {
          ...
          assert.deepEqual([
            {
              yep: [15],
              arr: [{a: [4, 8, 15, 16, 23, 42, 108, null], e: 'a'}, {a: {c: 48, b: [1], '7': 46}, e: 'b'}, {
                d: 'yep',
                e: 35
              }]
            }
